...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/icones/recursos/hdodec.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionVisualizar->setIcon(icon7);
        ...
        horizontalSliderPlano->setEnabled(true);
